...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    <div id="schoolclass" runat="server">
        ...
        <div id="class_edit_input">

            <section id="classcode_input" class="content-box">
            ...
            <section id="teacherid_input" class="content-box">
            ...
            <section id="startdate_input" class="content-box">
            ...
            <section id="finishdate_input" class="content-box">
            ...
            <section id="classname_input" class="content-box">
